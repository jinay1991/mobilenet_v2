...
class MobileNetV2(object):
    def __init__(self, net_data):
        self.weight1 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 3, 32)))
        self.bias1 = tf.Variable(tf.zeros(shape=(32)))
        self.weight2 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 32, 1)))
        self.bias2 = tf.Variable(tf.zeros(shape=(32)))
        self.weight3 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 32, 16)))
        self.bias3 = tf.Variable(tf.zeros(shape=(16)))
        self.weight4 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 16, 96)))
        self.bias4 = tf.Variable(tf.zeros(shape=(96)))
        self.weight5 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 96, 1)))
        self.bias5 = tf.Variable(tf.zeros(shape=(96)))
        self.weight6 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 96, 24)))
        self.bias6 = tf.Variable(tf.zeros(shape=(24)))
        self.weight7 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 24, 144)))
        self.bias7 = tf.Variable(tf.zeros(shape=(144)))
        self.weight8 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 144, 1)))
        self.bias8 = tf.Variable(tf.zeros(shape=(144)))
        self.weight9 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 144, 24)))
        self.bias9 = tf.Variable(tf.zeros(shape=(24)))
        self.weight10 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 24, 144)))
        self.bias10 = tf.Variable(tf.zeros(shape=(144)))
        self.weight11 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 144, 1)))
        self.bias11 = tf.Variable(tf.zeros(shape=(144)))
        self.weight12 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 144, 32)))
        self.bias12 = tf.Variable(tf.zeros(shape=(32)))
        self.weight13 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 32, 192)))
        self.bias13 = tf.Variable(tf.zeros(shape=(192)))
        self.weight14 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 192, 1)))
        self.bias14 = tf.Variable(tf.zeros(shape=(192)))
        self.weight15 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 192, 32)))
        self.bias15 = tf.Variable(tf.zeros(shape=(32)))
        self.weight16 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 32, 192)))
        self.bias16 = tf.Variable(tf.zeros(shape=(192)))
        self.weight17 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 192, 1)))
        self.bias17 = tf.Variable(tf.zeros(shape=(192)))
        self.weight18 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 192, 32)))
        self.bias18 = tf.Variable(tf.zeros(shape=(32)))
        self.weight19 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 32, 192)))
        self.bias19 = tf.Variable(tf.zeros(shape=(192)))
        self.weight20 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 192, 1)))
        self.bias20 = tf.Variable(tf.zeros(shape=(192)))
        self.weight21 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 192, 64)))
        self.bias21 = tf.Variable(tf.zeros(shape=(64)))
        self.weight22 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 64, 384)))
        self.bias22 = tf.Variable(tf.zeros(shape=(384)))
        self.weight23 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 384, 1)))
        self.bias23 = tf.Variable(tf.zeros(shape=(384)))
        self.weight24 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 384, 64)))
        self.bias24 = tf.Variable(tf.zeros(shape=(64)))
        self.weight25 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 64, 384)))
        self.bias25 = tf.Variable(tf.zeros(shape=(384)))
        self.weight26 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 384, 1)))
        self.bias26 = tf.Variable(tf.zeros(shape=(384)))
        self.weight27 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 384, 64)))
        self.bias27 = tf.Variable(tf.zeros(shape=(64)))
        self.weight28 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 64, 384)))
        self.bias28 = tf.Variable(tf.zeros(shape=(384)))
        self.weight29 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 384, 1)))
        self.bias29 = tf.Variable(tf.zeros(shape=(384)))
        self.weight30 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 384, 64)))
        self.bias30 = tf.Variable(tf.zeros(shape=(64)))
        self.weight31 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 64, 384)))
        self.bias31 = tf.Variable(tf.zeros(shape=(384)))
        self.weight32 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 384, 1)))
        self.bias32 = tf.Variable(tf.zeros(shape=(384)))
        self.weight33 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 384, 96)))
        self.bias33 = tf.Variable(tf.zeros(shape=(96)))
        self.weight34 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 96, 576)))
        self.bias34 = tf.Variable(tf.zeros(shape=(576)))
        self.weight35 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 576, 1)))
        self.bias35 = tf.Variable(tf.zeros(shape=(576)))
        self.weight36 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 576, 96)))
        self.bias36 = tf.Variable(tf.zeros(shape=(96)))
        self.weight37 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 96, 576)))
        self.bias37 = tf.Variable(tf.zeros(shape=(576)))
        self.weight38 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 576, 1)))
        self.bias38 = tf.Variable(tf.zeros(shape=(576)))
        self.weight39 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 576, 96)))
        self.bias39 = tf.Variable(tf.zeros(shape=(96)))

    def Mobilenet_v2(self, features, mu=0, sigma=1e-2):
        """
        ...
        with tf.compat.v1.variable_scope("B6"):
            # ------ n = 1 ------
            # expand
            self.weight40 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 96, 576)))
            ...
            # depthwise
            self.weight41 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 576, 1)))
            ...
            # conv
            self.weight42 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 576, 160)))
            ...
            # ------ n = 2 ------
            # expand
            self.weight43 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 160, 960)))
            ...
            # depthwise
            self.weight44 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 960, 1)))
            ...
            # conv
            self.weight45 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 960, 160)))
            ...
            # ------ n = 3 ------
            # expand
            self.weight46 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 160, 960)))
            ...
            # depthwise
            self.weight47 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 960, 1)))
            ...
            # conv
            self.weight48 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 960, 160)))
        ...
        with tf.compat.v1.variable_scope("B7"):
            # ------ n = 1 ------
            # expand
            self.weight49 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 160, 960)))
            ...
            # depthwise
            self.weight50 = tf.Variable(tf.random.truncated_normal(shape=(3, 3, 960, 1)))
            ...
            # conv
            self.weight51 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 960, 320)))
        ...
        with tf.compat.v1.variable_scope("C8"):
            self.weight52 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 320, 1280)))
        ...
        with tf.compat.v1.variable_scope("C10"):
            self.weight54 = tf.Variable(tf.random.truncated_normal(shape=(1, 1, 1280, 1001)))
            self.bias54 = tf.Variable(tf.zeros(shape=(1001)))
            conv54 = tf.nn.conv2d(pool53, self.weight54, strides=(1, 1, 1, 1), padding="SAME")
            conv54 = tf.nn.self.bias_add(conv54, self.bias54)
